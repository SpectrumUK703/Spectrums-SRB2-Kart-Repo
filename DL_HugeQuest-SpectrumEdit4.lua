...
local function HugeQuest(mo)
	...
	if p.growshrinktimer > 0 then
		if not (p.growfromlasers or (p.combiVars and p.combiVars.partner and p.combiVars.partner.valid and p.combiVars.partner.growfromlasers))	-- it made Shrink too powerful
			--print("Hugequest")
			p.offroad = 0
