...
local usefor = "kuze"
local usefortable = {}
usefortable["kuze"] = true
usefortable["freeza2nd"] = true
usefortable["waluigibike"] = true
usefortable["crazyfrog"] = true
usefortable["skip"] = true
usefortable["cacee&milne"] = true
usefortable["bulletbill"] = true
usefortable["milne"] = true
usefortable["boshi"] = true
usefortable["funky_kong"] = true
usefortable["pauline"] = true
usefortable["gemma"] = true
usefortable["sans"] = true
usefortable["bikerwario"] = true
...
addHook("PlayerExplode", function(p, inf, source)
	if not (inf and inf.valid and usefortable[p.mo.skin]) then return end
