// Spectrum
// minimal changes were needed for this to work in Ring Racers
	...
	for p in players.iterate
		...
		if p.skincolor == resetcolor
			if good and valid and p.realmo.skin
				...
				p.skincolor = P_RandomRange(SKINCOLOR_WHITE, SKINCOLOR_TAFFY) -- fuck it
			end
